<?php
  ...
  // Please define the following variables within the script that calls this library:
   ...
   define('AUTH_TITLE',      'Welcome to MidTrade');
   define('AUTH_TOKEN_TIME', 100);
   define('AUTH_IDENTIFIER', 'cb192768-00fe-4739-9d86-897bd4fe34b7');
   define('AUTH_SECRET',     'bfed784a-8313-474d-8e5a-18ab868bb6e8');
  ...
  login_redirect("login.php",$USER_CREDENTIALS['user']);
?>
